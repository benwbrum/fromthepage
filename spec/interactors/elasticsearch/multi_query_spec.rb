...
describe Elasticsearch::MultiQuery do
  ...
  let!(:article) { create(:article, collection: collection, pages: [page_1], title: identifier) }
  ...
  before(:each) do
    ...
    [owner, other_user, collection, other_collection, document_set, work_1, work_2, page_1, page_2, page_3, article]
      .each(&:save!)
  end
