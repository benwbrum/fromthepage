...
describe DashboardHelper do
  describe '#time_spent_in_date_range' do
    ...
    it 'calculates the total minutes worked within the date range' do
      create(:ahoy_activity_summary, user_id:, created_at: start_date, minutes: 120)
      create(:ahoy_activity_summary, user_id:, created_at: end_date, minutes: 180)
      create(:ahoy_activity_summary, user_id:, created_at: Date.new(2023, 2, 1), minutes: 90)
