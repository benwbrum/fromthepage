...
describe "omeka_items/new" do
  before(:each) do
    assign(:omeka_item, stub_model(OmekaItem,
      :title => "MyString",
      :subject => "MyString",
  ...
  it "renders new omeka_item form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => omeka_items_path, :method => "post" do
