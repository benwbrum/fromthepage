...
describe 'owner actions', order: :defined do
  ...
  it 'creates a new collection' do
    ...
    expect(page).to have_content(test_collection.title.to_s)
  ...
  it 'creates an empty new work in a collection', js: true do
    ...
    visit dashboard_owner_path
    click_link(test_collection.title.to_s)
    ...
    expect(Work.find_by(title: work_title)).not_to be_nil
  end
  ...
  it 'checks for subject in a new collection' do
    ...
    visit dashboard_owner_path
    page.find('.maincol').click_link(test_collection.title.to_s)
  ...
  it 'deletes a collection' do
    ...
    collection_count = @owner.all_owner_collections.count
    visit dashboard_owner_path
    expect(page.find('.maincol')).to have_content(test_collection.title.to_s)
    page.find('.maincol').click_link(test_collection.title.to_s)
    ...
    expect(page).not_to have_content(test_collection.title.to_s)
    expect(collection_count - 1).to eq @owner.all_owner_collections.count
  end
