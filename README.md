...
FromThePage has been run successfully under both Linux and Windows. It currently requires Ruby on Rails version 6.1.3.2 and the RMagick, hpricot, will_paginate, and OAI gems.
