...
#  page_id                 :integer
#  page_processing_task_id :integer
...
#  index_external_api_requests_on_page_processing_task_id  (page_processing_task_id)
...
#  fk_rails_...  (page_processing_task_id => page_processing_tasks.id)
