...
=end
  ...
  def searches
    ...
    unless this_week.empty?
      ...
      @find_a_project_average_hits = (this_week.where(search_type: 'findaproject').average(:hits) || 0).round(2)
      @collection_work_average_hits = (this_week.where.not(search_type: 'findaproject').average(:hits) || 0).round(2)
