class UserController < ApplicationController
  ...
  def user_params
    params.require(:user).permit(:real_name, :display_name, :orcid, :slug, :website, :location, :about, notifications: [:user_activity, :owner_stats, :add_as_collaborator, :add_as_owner, :note_added])
  end
