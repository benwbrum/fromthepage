    ...
    if current_user && CollectionBlock.find_by(collection_id: @collection.id, user_id: current_user.id).present?
      ...
      unless @collection.nil?
        ...
        if params[:work_search]
          ...
          @works = @collection.works.joins(:work_statistic).reorder('work_statistics.complete ASC', 'work_statistics.transcribed_percentage ASC').paginate(page: params[:page], per_page: 10)
          ...
          works = @collection.works.joins(:work_statistic).where(id: ids).reorder('work_statistics.complete ASC', 'work_statistics.transcribed_percentage ASC').paginate(page: params[:page], per_page: 10)
