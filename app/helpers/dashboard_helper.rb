module DashboardHelper
  ...
  def dashboard_set_title
    if is_active_link?(dashboard_startproject_path)
      content_for :page_title, 'Start A Project - Owner Dashboard'
    elsif is_active_link?(dashboard_owner_path)
      content_for :page_title, 'Your Works - Owner Dashboard'
    elsif is_active_link?(dashboard_summary_path)
  ...
  def tagged_collections
    unless defined? @@keyword_collections
      ...
      KEYWORD_TAGS.each do |tag, slugs|
        ...
        slugs.each do |slug|
          collection = Collection.where(slug:).first
          DocumentSet.where(slug:).first if collection.nil?
