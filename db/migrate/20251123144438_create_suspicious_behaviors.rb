class CreateSuspiciousBehaviors < ActiveRecord::Migration[7.2]
  def change
    create_table :suspicious_behaviors do |t|
      ...
      t.references :page, null: true, foreign_key: true, type: :integer
      t.references :collection, null: false, foreign_key: true, type: :integer
      t.references :deed, null: true, foreign_key: true, type: :integer
      t.string :behavior_type, null: false
      t.json :metadata
      t.datetime :flagged_at, null: false
      t.datetime :resolved_at, null: true
      t.references :resolved_by_user, null: true, foreign_key: { to_table: :users }, type: :integer
