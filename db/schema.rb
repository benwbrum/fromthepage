...
ActiveRecord::Schema.define(version: 2024_08_28_130535) do
  ...
  create_table "external_api_requests", id: :integer, charset: "utf8", collation: "utf8_general_ci", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "ai_job_id"
    t.integer "page_processing_task_id"
    ...
    t.index ["page_processing_task_id"], name: "index_external_api_requests_on_page_processing_task_id"
  ...
  create_table "page_processing_jobs", id: :integer, charset: "utf8", collation: "utf8_general_ci", force: :cascade do |t|
    t.string "status"
    t.integer "ai_job_id", null: false
    t.integer "page_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["ai_job_id"], name: "index_page_processing_jobs_on_ai_job_id"
    t.index ["page_id"], name: "index_page_processing_jobs_on_page_id"
  end

  create_table "page_processing_tasks", id: :integer, charset: "utf8", collation: "utf8_general_ci", force: :cascade do |t|
    t.string "type"
    t.integer "position"
    t.string "status"
    t.integer "page_processing_job_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.text "details"
    t.index ["page_processing_job_id"], name: "index_page_processing_tasks_on_page_processing_job_id"
  end
  ...
  add_foreign_key "external_api_requests", "page_processing_tasks"
  ...
  add_foreign_key "page_processing_jobs", "ai_jobs"
  add_foreign_key "page_processing_jobs", "pages"
  add_foreign_key "page_processing_tasks", "page_processing_jobs"
