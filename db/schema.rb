...
ActiveRecord::Schema.define(version: 2020_06_01_063806) do

  create_table "ahoy_activity_summaries", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci", force: :cascade do |t|
    t.datetime "date"
    t.integer "user_id"
  ...
  create_table "facet_configs", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci", force: :cascade do |t|
    t.string "label"
    t.string "input_type"
    t.string "order"
    t.bigint "metadata_coverage_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "metadata_coverages", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci", force: :cascade do |t|
    t.string "key"
    t.integer "count"
    t.integer "collection_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["collection_id"], name: "index_metadata_coverages_on_collection_id"
  end
  ...
  create_table "works", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "identifier"
    t.integer "next_untranscribed_page_id"
    t.text "original_metadata", size: :long, collation: "utf8mb4_bin"
